...
public class Scene {
	...
	private int visibleModelIndeces[];
	private GameModel visibleModels[];
	private int width;
	...
	public Scene(Surface surface, int maxModels, int maxPolygons,
		...
		for (int i1 = 0; i1 < 256; i1++) {
			anIntArray385[i1] = (int) (Math.sin(i1 * 0.02454369D) * 32768D);
			anIntArray385[i1 + 256] = (int) (Math.cos(i1 * 0.02454369D) * 32768D);
		}
