...
import net.projectp2p.rsc.gfx.components.Button;
import net.projectp2p.rsc.gfx.components.CheckBox;
...
public class ClanWarsCreateUI extends GraphicalOverlay {
	...
	public ClanWarsCreateUI(mudclient<?> mc) {
		...
		checkBoxRanged.setAction(new Action() {
			@Override
		...
		checkBoxMagic.setAction(new Action() {
			@Override
			public void action(int x, int y, int button) {
		...
		checkBoxPrayer.setAction(new Action() {
			@Override
			public void action(int x, int y, int button) {
		...
		checkBoxArmour.setAction(new Action() {
			@Override
			public void action(int x, int y, int button) {
		...
		timerdown.setAction(new Action() {
			@Override
			public void action(int x, int y, int button) {
				if (currenttime <= maxtime && currenttime > mintime) {
					currenttime--;
		...
		checkBoxNPCS.setAction(new Action() {
			@Override
			public void action(int x, int y, int button) {
